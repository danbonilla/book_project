...
<div id="container">
  <h2>No route matches [GET] &quot;/assets/js/ie-emulation-modes-warning.js&quot;</h2>

  
<p><code>Rails.root: /Users/danielbonilla/Desktop/smallBookProject/SmallBookSite</code></p>
...
<table id='route_table' class='route_table'>
  ...
  <td data-route-name='reviews'>
      reviews<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/reviews(.:format)' data-regexp='^\/reviews(?:\.([^\/.?]+))?$'>
    /reviews(.:format)
  </td>
  <td data-route-reqs='reviews#index'>
    reviews#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_review'>
      new_review<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/reviews/new(.:format)' data-regexp='^\/reviews\/new(?:\.([^\/.?]+))?$'>
    /reviews/new(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_review'>
      edit_review<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/reviews/:id/edit(.:format)' data-regexp='^\/reviews\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /reviews/:id/edit(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='review'>
      review<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/reviews/:id(.:format)' data-regexp='^\/reviews\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /reviews/:id(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='authors'>
      authors<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/authors(.:format)' data-regexp='^\/authors(?:\.([^\/.?]+))?$'>
    /authors(.:format)
  </td>
  <td data-route-reqs='authors#index'>
    authors#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='authors#create'>
    authors#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_author'>
      new_author<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/authors/new(.:format)' data-regexp='^\/authors\/new(?:\.([^\/.?]+))?$'>
    /authors/new(.:format)
  </td>
  <td data-route-reqs='authors#new'>
    authors#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_author'>
      edit_author<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/authors/:id/edit(.:format)' data-regexp='^\/authors\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /authors/:id/edit(.:format)
  </td>
  <td data-route-reqs='authors#edit'>
    authors#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='author'>
      author<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/authors/:id(.:format)' data-regexp='^\/authors\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /authors/:id(.:format)
  </td>
  <td data-route-reqs='authors#show'>
    authors#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='authors#update'>
    authors#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='authors#destroy'>
    authors#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/books(.:format)' data-regexp='^\/books(?:\.([^\/.?]+))?$'>
    /books(.:format)
  </td>
  <td data-route-reqs='books#index'>
    books#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='books#create'>
    books#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_book'>
      new_book<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/books/new(.:format)' data-regexp='^\/books\/new(?:\.([^\/.?]+))?$'>
    /books/new(.:format)
  </td>
  <td data-route-reqs='books#new'>
    books#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_book'>
      edit_book<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/books/:id/edit(.:format)' data-regexp='^\/books\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /books/:id/edit(.:format)
  </td>
  <td data-route-reqs='books#edit'>
    books#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='book'>
      book<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/books/:id(.:format)' data-regexp='^\/books\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /books/:id(.:format)
  </td>
  <td data-route-reqs='books#show'>
    books#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='books#update'>
    books#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='books#destroy'>
    books#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;KObIIYDLCO1M0868NbI6BT/oImCXE8SLGjWoxEI0r+c=&quot;
session_id: &quot;6315a98929360710825ea21b710353a0&quot;</pre></div>
</div>
...
<div id="console"
  data-remote-path='console/repl_sessions/c09e8a65a043574b72f7380519c9f8bb'
  data-initial-prompt='>> '>
</div>
